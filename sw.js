...
const CACHE_NAME = 'directivas-os10-cache-v43'; // Incrementado para forzar actualización en todos los usuarios
...
const urlsToCache = [
  ...
  './assets/js/chatbot.min.js?v=3',
  './assets/js/search.min.js?v=9',
  './rules/chatbot-rules.js?v=8',
  // Iconos y logos
