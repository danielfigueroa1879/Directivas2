...
const responses = {
    ...
    'rule_37': { keywords: ["decreto 32"], response: '*Decreto. 32 DECRETO 32 EXENTO MODIFICA EN TÉRMINOS QUE INDICA DECRETO N°261 EXENTO, DE 2020, DEL MINISTERIO DEL INTERIOR Y SEGURIDAD PÚBLICA, QUE APRUEBA MANUAL OPERATIVO EN MATERIAS DE SEGURIDAD PRIVADA Y FIJA SU TEXTO ACTUALIZADO*. https://www.bcn.cl/leychile/navegar?idNorma=1200633' },
    'rule_39': { keywords: ["*21659*", "*nueva ley de seguridad*"], response: '🤖📚 **LEY 21.659 VIGENTE**\nLa Ley de Seguridad Privada y sus reglamentos (Decreto 209 y 208) están vigentes. Establece nuevas categorías de riesgo, infracciones y procedimientos.\nVer ley: https://www.bcn.cl/leychile/navegar?idNorma=1202067&idVersion=2026-05-28' },
    'rule_39a': { keywords: ["21806", "*21806*"], response: '🤖📚 **LEY 21.806** Extensión de Autoridades Gobernadores y Vicegobernadores.\nhttps://www.bcn.cl/leychile/navegar?idNorma=1221118' },
    'rule_39b': { keywords: ["21825", "*21825*"], response: '🤖📚 **LEY 21.825** Modifica la Ley 21.659 - Aumenta plazo de estudios de seguridad de 6 a 18 meses y extiende vigencia de la última autorización del personal.\nhttps://www.bcn.cl/leychile/navegar?idNorma=1224572' },
    'rule_39c': { keywords: ["208", "*reglamento 208*"], response: '🤖📚 **REGLAMENTO 208** Reglamento de Eventos Masivos (Ley 21.659).\nhttps://www.bcn.cl/leychile/navegar?idNorma=1211115' },
    ...
    'rule_98': { keywords: ["Valores","cuanto cuesta","cual es el valor","valor plan","valores planes","valores plan","*valor*","*cuesta*","precio credencial","valor credencial","valor una credencial","valor 1 credencial","precio 1 credencial"], response: '🤖💰 **VALORES 2° SEMESTRE 2026** _(vigentes desde el 01.07.2026 hasta el 31.12.2026)_\n\n**1 credencial de personal cuesta 6.123 pesos** — mismo valor para todos los componentes (por UNA credencial):\n\n⬜ **Guardia de Seguridad** — fondo foto: **blanco**\n🟥 **Vigilante Privado** — fondo foto: **rojo**\n🟦 **Supervisor de Seguridad** — fondo foto: **azul**\n🟦 **Asesor en Seguridad** — fondo foto: **azul**\n🟦 **Capacitador** — fondo foto: **azul**\n🟦 **Jefe de Seguridad** — fondo foto: **azul**\n🟦 **Encargado de Armas / Operador de Cámaras / Técnico** — fondo foto: **azul**\n\n⚠️ **MÁS DE UNA CREDENCIAL:** Los valores son **DISTINTOS** según la cantidad y **NO se pueden sumar**. Debes descargar el cuadro oficial de valores:\n\n<a href="https://drive.google.com/uc?export=download&id=1CO9egHu6DydS51hKyDnxkg2BdDPj-vZZ" download="valores.pdf" class="response-button block w-full text-left bg-red-500 hover:bg-red-600 border border-red-600 text-white text-sm py-1.5 px-3 rounded-lg transition-all font-medium">📥 Descargar cuadro de valores (más de 1 credencial)</a>\n\n**CREDENCIAL EMPRESA:** 6.123 pesos (por 1 credencial)\n\n📄 **PLAN DE SEGURIDAD:** **40.823 pesos**\n<a href="https://drive.google.com/file/d/12mg35jowBvw1zX8z-jU2gZg_ALjBCIBD/view" target="_blank" class="response-button block w-full text-left bg-blue-500 hover:bg-blue-600 border border-blue-600 text-white text-sm py-1.5 px-3 rounded-lg transition-all font-medium">📥 Ver cuadro Valor Plan</a>\n\n**CURSOS:** Se gestionan directamente con la **SPD** por la empresa de capacitación — O.S.10 no tramita cursos.\n\n<button onclick="showCredenciales()" class="response-button block w-full text-left bg-yellow-500 hover:bg-yellow-600 border border-yellow-600 text-white text-sm py-1.5 px-3 rounded-lg transition-all font-medium">📋 Ir a sección Credenciales</button>' },
    'rule_98b': { keywords: ["mas de una credencial","más de una credencial","varias credenciales","valor varias credenciales","precio varias credenciales","valor mas credenciales","valor mas de una","precio mas de una","dos credenciales","tres credenciales","cinco credenciales","10 credenciales","lote de credenciales","descuento credenciales","cantidad credenciales","valor multiples credenciales","multiples credenciales","valor lote","precio lote"], response: '🤖⚠️ **VALOR DE MÁS DE UNA CREDENCIAL — 2° SEMESTRE 2026**\n\nCuando se tramitan **varias credenciales a la vez**, los valores son **DISTINTOS según la cantidad** y **NO se pueden sumar** multiplicando 6.123 × cantidad.\n\n👉 Para conocer el valor exacto, debes **descargar el cuadro oficial de valores**:\n\n<a href="https://drive.google.com/uc?export=download&id=1CO9egHu6DydS51hKyDnxkg2BdDPj-vZZ" download="valores.pdf" class="response-button block w-full text-left bg-red-500 hover:bg-red-600 border border-red-600 text-white text-sm py-1.5 px-3 rounded-lg transition-all font-medium">📥 Descargar cuadro oficial de valores</a>\n\n📌 *Recuerda:* 1 credencial = 6.123 pesos, pero desde 2 credenciales en adelante el valor por unidad varía y **solo el cuadro oficial tiene los montos correctos.**' },
    'rule_98c': { keywords: ["valor plan","valor plan de seguridad","precio plan","precio plan de seguridad","cuanto cuesta el plan","cuanto vale el plan","costo plan","costo plan de seguridad","arancel plan","plan de seguridad valor","cuanto cuesta plan seguridad"], response: '🤖📄 **VALOR PLAN DE SEGURIDAD — 2° SEMESTRE 2026** _(01.07.2026 – 31.12.2026)_\n\n💰 **Plan de Seguridad: 40.823 pesos**\n\nCuadro oficial de valores del Plan:\n\n<a href="https://drive.google.com/file/d/12mg35jowBvw1zX8z-jU2gZg_ALjBCIBD/view" target="_blank" class="response-button block w-full text-left bg-blue-500 hover:bg-blue-600 border border-blue-600 text-white text-sm py-1.5 px-3 rounded-lg transition-all font-medium">📥 Ver / Descargar cuadro Valor Plan</a>\n\n📌 Pago mediante VALE VISTA a nombre de: **ZONA DE CARABINEROS SEGURIDAD PRIVADA CONTROL DE ARMAS Y EXPLOSIVOS** — R.U.T. 61.944.800-6.' },
    ...
    'rule_201': { keywords: ["y tiene los valores","y tiene los valores del plan","credenciales empresa","los valores","valores credencial","cual es el valor","cuanto cuesta","plan"], response: '🤖🧙🏻‍♂️ *VALORES 2° SEMESTRE 2026* _(01.07.2026 – 31.12.2026)_\n\n💳 *1 CREDENCIAL:* 6.123 pesos (mismo valor para todos los componentes)\n\n⚠️ *MÁS DE 1 CREDENCIAL:* Valores DISTINTOS — NO se pueden sumar. Descarga el cuadro oficial:\n\n📥 https://drive.google.com/uc?export=download&id=1CO9egHu6DydS51hKyDnxkg2BdDPj-vZZ\n\n📄 *PLAN DE SEGURIDAD:* 40.823 pesos\n📥 https://drive.google.com/file/d/12mg35jowBvw1zX8z-jU2gZg_ALjBCIBD/view' },
...
11.- **TRANSITORIEDAD (Art. 20 Ley 21.659):** Durante el período de transitoriedad, la oficina O.S.10 Coquimbo SIGUE tramitando credenciales, directivas de funcionamiento y planes de seguridad. Esta responsabilidad se está traspasando de forma gradual a la SPD (Subsecretaría de Prevención del Delito), pero mientras ese proceso no esté completo, O.S.10 continúa siendo la entidad competente. Si alguien pregunta quién tramita credenciales, directivas o planes, responde que actualmente lo sigue haciendo O.S.10 en virtud del artículo 20 de la Ley 21.659 (transitoriedad), y que poco a poco esto pasará a la SPD.
12.- **VALORES DE CREDENCIALES Y PLAN (2° semestre 2026, vigente 01.07.2026 – 31.12.2026):** UNA (1) credencial de personal cuesta **6.123 pesos** — mismo valor para todos los componentes (guardia, vigilante, jefe de seguridad, supervisor, asesor, encargado de armas, operador de cámaras, técnico/instalador). Credencial empresa: **6.123 pesos** por 1 credencial. **PLAN DE SEGURIDAD: 40.823 pesos** — cuadro oficial: https://drive.google.com/file/d/12mg35jowBvw1zX8z-jU2gZg_ALjBCIBD/view. **IMPORTANTE — MÁS DE UNA CREDENCIAL:** Cuando el usuario pregunte por más de una credencial (2, 3, 5, 10, varias, un lote, etc.), los valores son DISTINTOS según la cantidad y **NO se pueden sumar** multiplicando 6.123 × N. Debes indicar al usuario que descargue el cuadro oficial de valores: https://drive.google.com/uc?export=download&id=1CO9egHu6DydS51hKyDnxkg2BdDPj-vZZ — nunca inventes ni calcules totales para múltiples credenciales. Los cursos (formación y perfeccionamiento) NO se tramitan en OS10, van directo a la SPD por la empresa de capacitación. IMPORTANTE: nunca uses el signo $ al indicar valores, siempre escribe el número seguido de la palabra "pesos".
13.- **CONTINUIDAD DE CONVERSACIÓN:** Si el usuario hace una pregunta corta de seguimiento como "¿y para el jefe de seguridad?", "¿y el supervisor?", "¿y para X?", mantén el MISMO TEMA de la pregunta anterior. Si antes preguntaron por un valor o costo, responde con el valor/costo para ese rol. NO cambies el tema a requisitos o tramitación a menos que el usuario lo pida explícitamente.
