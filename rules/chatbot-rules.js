const responses =  {
    ...
    'rule_2': { keywords: ["infracciones", "sanciones guardias", "multas guardias", "decreto 93", "guardia sin curso", "guardia sin credencial", "guardia sin directiva", "guardia con arma"], response: 'Infracciones de Guardias (Decreto Supremo N° 93):\n\n*Guardia sin curso OS10 (Art. 13):* La empresa que contrata es la infractora.\n\n*Guardia sin credencial vigente (Art. 18):* Responsabilidad de la empresa contratante.\n\n*Sin Directiva de Funcionamiento (DD.FF.) (Art. 15):* Es una infracción de la empresa.\n\n*Portando elementos no autorizados (Art. 14):* Infracción aplicable a la empresa.\n\n*Portando arma de fuego (Art. 14):* Grave infracción atribuible a la empresa.' },
    ...
    'rule_11': { keywords: ["la guia de asesor"], response: '🤖 ASESOR\n**GUÍA:* \nhttps://www.zosepcar.cl/content/OS10/TRAM_asesor.pdf' },
