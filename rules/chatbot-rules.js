...
const responses = {
    ...
    'rule_98': { keywords: ["Valores","cuanto cuesta","cual es el valor","valor plan","valores planes","valores plan","*valor*","*cuesta*"], response: '🤖🧙🏻‍♂️ *AQUI ESTAN LOS VALORES 2DO. SEMESTRE 2025* *1 CREDENCIAL* https://dal5.short.gy/val *2 CREDENCIAL EMPRESA* https://dal5.short.gy/C.emp  *3 CURSO FORMACIÓN* https://dal5.short.gy/Form  *4 CURSO PERFECC* https://dal5.short.gy/BjzkHI *5 VALOR PLAN* https://os10.short.gy/Pl4n  ' },
