...
const responses = {
    ...
    'rule_98': { keywords: ["Valores","cuanto cuesta","cual es el valor","valor plan","valores planes","valores plan","*valor*","*cuesta*"], response: '🤖🧙🏻‍♂️ *VALORES SEGUNDO SEMESTRE*\n 1.- CREDENCIAL\n https://dal5.short.gy/val 2.- CREDENCIAL DE EMPRESA\n https://dal5.short.gy/C.emp  3.- CURSO DE FORMACIÓN\n https://dal5.short.gy/Form  4.- CURSO PERFECCIONAMIENTO\n https://dal5.short.gy/BjzkHI 5.- VALOR PLAN\n https://os10.short.gy/Pl4n ' },
