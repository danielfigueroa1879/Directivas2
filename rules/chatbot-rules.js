...
const responses = {
    ...
    'rule_98': { keywords: ["Valores","cuanto cuesta","cual es el valor","valor plan","valores planes","valores plan","*valor*","*cuesta*","precio credencial","valor credencial"], response: '🤖💰 **VALORES 1° SEMESTRE 2026** _(vigentes hasta el 30.06.2026)_\n\n**1. CREDENCIAL (guardia/personal):** $5.960\n**2. CREDENCIAL EMPRESA:** $5.960\n**3. CURSOS (Formación y Perfeccionamiento):** Los cursos son gestionados directamente por la empresa de capacitación ante la **SPD** — O.S.10 no tramita cursos.\n**4. PLAN DE SEGURIDAD:** $39.732\n\n📋 _Comprobante oficial:_\nhttps://dal5.short.gy/val' },
