...
const predefinedResponses = {
    'rule_3': { keywords: ["*horario*","*atención*","*horarios*","*como llego*","*como puedo llegar*", "*donde estan*", "*donde esta el os10 coquimbo*", "*donde esta el os10*","*donde*"], response: '🤖 👉🏼 OS10 Coquimbo De lunes a jueves de 09:00 horas a 13:00 horas. Cienfuegos 180, La Serena. Fono 512651024 https://maps.app.goo.gl/QUhujWbTF1FjDA7E6' },
