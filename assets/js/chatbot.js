...
const predefinedResponses = {
    ...
    'rule_65': { keywords: ["*correos*","*correo*", "*fono*", "*telefono*","*numero*","*ubicados*","*dirección*","*atención*","*horario*","*horarios*","*ubicación*","*direccion oficina*","*cual es la dirección del os10*","*horario atención publico*", "*donde estan*", "*donde esta el os10 coquimbo*", "*donde esta el os10*","*donde*", "*direccion*"], response: '🤖 👉🏼 OS10 Coquimbo\nDe lunes a jueves de 09:00 horas a 13:00 horas.\nCienfuegos 180, La Serena.\nFono 512651024\nhttps://maps.app.goo.gl/QUhujWbTF1FjDA7E6' },
