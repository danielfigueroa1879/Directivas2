...
const styles = `
    ...
    #chat-popup {
        ...
        position: absolute;
        bottom: 80px; /* Ajustado para dejar espacio al botón */
        right: 0;
        height: 70vh;
        max-height: 550px;
        width: 90vw;
        ...
        /* Nuevas propiedades para evitar que se salga de la pantalla */
        max-height: calc(100vh - 200px); /* Limita la altura máxima */
        overflow: hidden; /* Evita desbordamiento */
    }
    
    /* Asegurar que en pantallas pequeñas no se salga */
