...
'rule_261': { keywords: ["hola","buenos días","buenas tardes","buenas noches","saludos"], response: '🤖👮🏻‍♂️ ¡Buenos días! Bienvenido/a a la Oficina de Seguridad Privada OS10 Coquimbo. Mi nombre es AsistentBot y estoy aquí para ayudarle con sus consultas. ¿En qué puedo asistirle hoy?' },
...
'rule_273': { keywords: ["reclamo","queja","molesto","disconforme"], response: '🤖📋 Lamento escuchar que tiene una situación que le molesta. Su satisfacción es importante para nosotros. Por favor, cuénteme los detalles de su inconveniente para poder ayudarle adecuadamente o derivarle al área correspondiente.' },
