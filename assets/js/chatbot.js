...
'rule_286': { keywords: ["*guardia sin curso*","*vigilante sin capacitación*","*sin formación*"], response: '🤖⚠️ Un guardia sin curso de capacitación NO puede ejercer funciones. Según el DL 3607 art. 1°, es OBLIGATORIO contar con curso de formación aprobado. Multa: 25 a 125 ingresos mínimos mensuales (primera vez), hasta 250 en reincidencia.' },
'rule_287': { keywords: ["*guardia sin credencial*","vigilante sin autorización","*sin credencial*","si no tengo credencial"], response: '🤖❌ Un guardia sin credencial vigente NO puede trabajar. La credencial es requisito esencial según DL 3607. Ejercer sin credencial constituye infracción grave. Multa: 25 a 125 ingresos mínimos mensuales, duplicándose en reincidencia.' },
