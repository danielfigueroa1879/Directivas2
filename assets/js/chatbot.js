...
const predefinedResponses = {
    'rule_1': { keywords: ["figueroa","mi suboficial","mi sargento"], response: '🧙🏻‍♂️ no estoy de servicio, puede llamar al 512651024 o esperar la atención de lunes a viernes de 08:30 a 13:00 horas. Gracias 👍✌️' },
    'rule_2': { keywords: ["*mi suboficial*","*mi sargento*"], response: 'Estoy con unos días de descanso vuelvo el viernes, saludos 🙂 👍🏼' },
    'rule_3': { keywords: ["*horario*","*atención*","*horarios*","*como llego*","*como puedo llegar*"], response: '🤖 👉🏼 OS10 Coquimbo De lunes a jueves de 09:00 horas a 13:00 horas. Cienfuegos 180, La Serena. Fono 512651024 https://maps.app.goo.gl/QUhujWbTF1FjDA7E6' },
    'rule_4': { keywords: ["guías","guía","componentes del sistema","componentes"], response: '*ESCRIBA EL NOMBRE DEL COMPONENTE DEL SISTEMA Y SE DESCARGARA UNA GUIA, PARA QUE PUEDA REALIZAR SU TRAMITE*👮🏻‍♂️ \n ⬇️\n*1.-* VIGILANTE PRIVADO\n*2.-* GUARDIA DE SEGURIDAD\n*3.-* JEFE DE SEGURIDAD \n*4.-* ENCARGADO DE SEGURIDAD\n*5.-* SUPERVISOR\n*6.-* ASESOR \n*7.-* CAPACITADOR\n*8.-* TÉCNICO \n*9.-* OPERADOR DE CAJEROS \n*10.-* INSTALADOR TÉC. DE SEGURIDAD\n*11.-* OPERADOR CCTV.\n*12.-* EMPRESAS' },
    ...
    'rule_97': { keywords: ["valor plan","valores planes","valores plan"], response: '🤖🧙🏻‍♂️ *PAGO PLAN DE SEGURIDAD SEMESTRE*\nhttps://os10.short.gy/Pl4n' },
    'rule_98': { keywords: ["Valores","valor","cuanto cuesta","cual es el valor"], response: '🤖🧙🏻‍♂️ *AQUI ESTAN LOS VALORES 2DO. SEMESTRE 2025*\n\n1.- *CREDENCIAL*\ndal5.short.gy/val' },
    'rule_99': { keywords: ["buenos dias os.10 coquimbo","consultado a cenco sin novedad","sin novedad"], response: '* *' },
    'rule_100': { keywords: ["weon","maricon","culiao","feo culiao","merda."], response: '🧙🏻‍♂️' },
    'rule_101': { keywords: ["claves"], response: '🤖 *CLAVES*\n*Actas:* curso2004Arica\n*Reunion teams:* os.10\n*Zoom:* 12345\n*Usuario Diploma:* 982083a / Contraseña: Flor9820&' },
    ...
    'rule_151': { keywords: ["*bitácora*","*ingresar detenido*"], response: '🤖👉🏼 *BITÁCORA WEB*\n\nhttp://172.30.20.201:8200/index.php' },
    ...
    'rule_154': { keywords: ["*facultades vigilante*","*fiscalizar vigilante*"], response: '🧙🏻‍♂️👮🏻‍♂️🏦☝️ LAS FACULTADES CONFERIDAS A CARABINEROS DE CHILE CONFORME LO SIGUIENTE PARA *VIGILANTES PRIVADOS Y ENTIDAD OBLIGADAS* SEGÚN EL ARTICULO 3 DEL DECRETO 3.607' },
    ...
    'rule_159': { keywords: ["*facultades guardias*","*facultades*"], response: '☝️ LAS FACULTADES CONFERIDAS A CARABINEROS DE CHILE CONFORME LO SIGUIENTE PARA *GUARDIA DE SEGURIDAD Y EMPRESAS*' },
    ...
    'rule_189': { keywords: ["cuenta banco"], response: '*CUENTA BANCO*\n*Banco Scotiabank*\n*RUT 13.637.254-8*\n*Cuenta Vista*\n*Numero cuenta:* \n985663580' },
    'rule_190': { keywords: ["mi cedula"], response: '☝🏼🤖 *Cédula Identidad*\nhttps://dal5.short.gy/7MaLwH' },
    'rule_191': { keywords: ["enfermedad de peyronie"], response: '*Enfermedad de Peyronie*\nhttps://drjromero-otero.com/xiapex-romero-otero/' },
    ...
    'rule_200': { keywords: ["mi cedula"], response: '☝🏼🤖 *Cédula Identidad 2024* https://drive.google.com/file/d/1so7Cr9R25KCjUe0QGiQ_IJy9BRXM_AR1/view?usp=drivesdk' },
    ...
    'rule_205': { keywords: ["ultimos reclamos"], response: '🤖👉🏼 *ultimos reclamos*\nhttps://os10.short.gy/21' },
    ...
    'rule_210': { keywords: ["mi nombre es"], response: 'Mi nombre es máximo décimo Meridio, comandante de los ejércitos del Norte, General de las legiones Felix' },
    'rule_211': { keywords: ["primero que nada"], response: 'Primero que nada hay que aceptar que casi todo lo que estamos aquí tenemos una cosa en común' },
    'rule_212': { keywords: ["navidad"], response: 'Hola! ¡Muy buenos días y *Feliz Navidad*! 🎄✨\n\nQue esta Navidad te brinde momentos de paz, amor y alegría' },
    'rule_213': { keywords: ["fotografía","fotito"], response: '*1.- FOTOSTORE:* Calle Prat 629, La Serena.\nUbicación: *https://dal5.short.gy/629*' },
    'rule_214': { keywords: ["tabla servicio","tabla"], response: '*Tabla de servicio diciembre 2024*\n*https://dal5.short.gy/Dic24*' },
    ...
    'rule_217': { keywords: ["clave"], response: '🤖☝🏼 *CLAVES*\n\n*https://dal5.short.gy/Cla*' },
    ...
    'rule_228': { keywords: ["turnos","turno"], response: '*TURNOS*\n*https://dal5.short.gy/Tur*' },
    'rule_229': { keywords: ["página de seguridad privada","proyecto titulo"], response: '*PAGINA WEB FISCALIZACIONES SEGURIDAD PRIVADA*\n\nhttps://danielfigueroa1879.github.io/SeguridadPrivada/' },
    'rule_230': { keywords: ["generador credenciales"], response: '*Emulador Generador de credenciales* \n\nhttps://dal5.short.gy/Cr3' },
    'rule_231': { keywords: ["ingreso de turnos","ingresar turnos"], response: '*INGRESAR TURNOS OPERADORES*\n\nhttps://dal5.short.gy/Tu3' },
    'rule_232': { keywords: ["80"], response: '🧙🏼‍♂️ *RESOLUCIÓN 80* \n\nhttps://www.zosepcar.cl/content/OS10/resolucion_80.pdf' },
    'rule_233': { keywords: ["maquinas virtuales","pentesting","red taming","maquina virtual"], response: '🤖 *MAQUINAS VIRTUALES PARA PROFESIONALES DE LA CIBERSEGURIDAD*' },
    'rule_234': { keywords: ["comprar pistola","compra armamento","compra pistola"], response: '*INDICACIONES AA.FF.*\n\n• SOLICITUD\n• COTIZACIÓN' },
    'rule_235': { keywords: ["calendario cristobal"], response: '🤖👉🏼 *CALENDARIO 2025*\ndal5.short.gy/Crist25' },
    'rule_236': { keywords: ["nacimiento dvd"], response: '*NACIMIENTO CRISTÓBAL*\n*PARTE 1*\ndal5.short.gy/Cri1' },
    'rule_237': { keywords: ["prompt para crear aplicacion","crear aplicación","crear pagina"], response: '🧙🏼‍♂️ *CREAR PROYECTO DE APLICACION O PAGINA*' },
    ...
    'rule_241': { keywords: ["fiscalizar hospital","informe hospital"], response: 'https://danielfigueroa1879.github.io/Informe/' },
    'rule_242': { keywords: ["feliz día","feliz día del carabinero","feliz 27","feliz días"], response: 'Gracias, muchas gracias 😊👌🏼👍🏼' },
    ...
    'rule_249': { keywords: ["oro seguridad","oro"], response: '🧙🏼‍♂️🤖 *Seguridad privada Oro*\nhttps://dal5.short.gy/Oro' },
    'rule_250': { keywords: ["promp crear página","hamburguesa"], response: '🤖 *Página con menú de hamburguesa*\n\n\"necesito que crees la pagina que te muestro en el pdf modelo de pagina\"' },
    'rule_251': { keywords: ["modelos de páginas web"], response: '🤖 *Modelos de páginas web*\n\n1. Sitio Web de Una Sola Página (One Page): Ideal para sitios con contenido breve y directo' },
