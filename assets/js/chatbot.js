...
// Función principal de TTS con fallback inteligente
    ...
    function addMessage(sender, text, buttons = [], speakMessage = true, trackHistory = true) {
        ...
        if (sender === 'user') {
            ...
            content = `<div class="w-8 h-8 rounded-full bg-white border-2 border-yellow-400 flex items-center justify-center flex-shrink-0 p-1"><img src="assets/images/poli.webp?v=2" alt="Bot Icon" class="h-full w-full object-contain"></div><div class="bg-gray-100 p-3 rounded-lg max-w-sm text-gray-800 leading-tight">${formattedText}${buttonsHtml}</div>`;
