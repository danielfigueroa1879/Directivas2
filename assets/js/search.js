                ...
                <div class="search-results-container">
                    ...
                    <div id="search-help" class="search-help">
                        ...
                        <div class="search-suggestions">
                            ...
                            <button class="suggestion-pill" data-search="normativa">Actualizaciones Normativas</button>
                            <button class="suggestion-pill" data-search="anterior">Normativa Anterior</button>
    ...
    buildSearchIndex() {
        this.searchIndex = [
            ...
            },
            {
                ...
                section: 'Marco Legal',
                action: () => window.open('https://www.bcn.cl/leychile/navegar?idNorma=1202067&idVersion=2026-05-28', '_blank'),
            ...
            },
            {
            ...
            },
             {
                ...
                section: 'Actualizaciones Normativas',
            ...
            // SECCIÓN: Actualizaciones Normativas (Resoluciones vigentes)
            {
...
if (document.readyState === 'loading') {
    ...
    window.globalSearch = new GlobalSearc