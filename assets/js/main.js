...
function handleCerofilas() { window.openNewLink('https://dal5.short.gy/CFil'); }
...
function handleValorPlan() { window.openNewLink('https://os10.short.gy/Pl4n'); }
function handleCursoFormacion() { window.openNewLink('https://dal5.short.gy/Form'); }
function handleMarcoLegal() { window.openNewLink('https://www.zosepcar.cl/OS10.php#leyes'); }
/**
 * assets/js/main.js
 * Este archivo contiene la lógica para la interfaz de usuario,
 * animaciones y el banner para instalar la PWA.
